...
#SBATCH --output=convert_arxiv-pilev2_short_%j.out
#SBATCH --error=convert_arxiv-pilev2_short_%j.out
#SBATCH --time=2:00:00
...
OUT_NAME=arxiv-pilev2_short_hf
INPUT_DIR=/home/za2514/compute/saved-weights/proofgpt_v0.7/llama_7b_arxiv-pilev2_short/global_step${STEP}
OUT_DIR=/home/za2514/compute/saved-weights/proofgpt_v0.7/${OUT_NAME}
CONFIG_FILE=/home/za2514/compute/math-lm/gpt-neox/configs/v0.7/llama_7b_arxiv-pilev2_short.yml
