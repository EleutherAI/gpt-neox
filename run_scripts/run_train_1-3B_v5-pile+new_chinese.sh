...
#SBATCH --job-name=train_1-3B_v5-pile+new_chinese
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v5-pile+new_chinese params.yml setup.yml -H 1-3B_v5_hostfile
