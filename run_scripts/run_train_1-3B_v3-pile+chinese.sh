...
#SBATCH --job-name=train_1-3B_v3-pile+chinese
...
### 执行你的作业
python ./deepy.py train.py -d jarvis_configs/1-3B/v3-pile+chinese params.yml setup.yml -H jarvis_configs/1-3B/v3-pile+chinese/1-3B_v3_hostfile
