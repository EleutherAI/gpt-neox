...
#SBATCH --output=tokenize_proof-pile-v1_test_%j.out
#SBATCH --error=tokenize_proof-pile-v1_test_%j.out
#SBATCH --time=1-00:00:00

# BYU cluster
SUBSET=proof-pile-v1
SPLIT="test_alt"

echo $SUBSET

DATA_DIR="/home/za2514/compute/proof-pile-v1_llama/${SPLIT}"
