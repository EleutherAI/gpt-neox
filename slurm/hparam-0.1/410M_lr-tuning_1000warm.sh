...
#SBATCH --output=410M_lr-tuning_1000warm_%a_%A.out
#SBATCH --error=410M_lr-tuning_1000warm_%a_%A.out
...
declare -a args=(
    "0.0003,0.00003,256" "0.003,0.0003,256" "0.006,0.0006,256" "0.01,0.001,256"
)
