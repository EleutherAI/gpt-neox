...
#SBATCH --job-name="tokenize_llama-web_text_zh"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/web_text_zh/web_text_zh-train.jsonl\
            --output-prefix /fs/fast/u2020000280/data/web_text_zh_llama_tokenized/train \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/web_text_zh/web_text_zh-val.jsonl\
            --output-prefix /fs/fast/u2020000280/data/web_text_zh_llama_tokenized/val \
            --vocab ../../../../../jarvis/llama-7b-hf/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
