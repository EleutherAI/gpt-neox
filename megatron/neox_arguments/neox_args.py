...
class NeoXArgsLRScheduler(NeoXArgsTemplate):
    ...
    warmup: float = None
    """
    Unused, purely for backwards compatbility with conversion scripts
    """
    ...
    warmup_max_iters: int = None
    """
    Sets warmup_iters = min(warmup_ratio*train_iters, warmup_max_iters)
    """
