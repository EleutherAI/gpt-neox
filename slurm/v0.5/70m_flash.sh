...
#SBATCH --output=70m_flash_%x_%j.out
#SBATCH --error=70m_flash_%x_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/math-lm/gpt-neox/configs/v0.5/ 70M_flash.yml
