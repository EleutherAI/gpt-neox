# Adapted from https://github.com/state-spaces/mamba/blob/main/mamba_ssm/ops/triton/layernorm.py . 
# Fused triton RMSNorm / LayerNorm kernels.
# Also allows for fused adding residual + layernorm but we haven't integrated that yet.
...
# TODO: remove ref fns
# TODO: document if/how eps behavior differs from our RMSnorm and from our layernorm + apex LN
# and consider changing RMSNorm torch behavior in NeoX since it seems nonstandard
