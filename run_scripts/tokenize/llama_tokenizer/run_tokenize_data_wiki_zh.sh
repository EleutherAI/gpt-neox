...
#SBATCH --job-name="tokenize_llama-wiki_zh"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/wiki_zh/wiki_zh-train.jsonl\
            --output-prefix /fs/fast/u2020000280/data/wiki_zh_llama_tokenized/train \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/wiki_zh/wiki_zh-val.jsonl\
            --output-prefix /fs/fast/u2020000280/data/wiki_zh_llama_tokenized/val \
            --vocab ../../../../../jarvis/llama-7b-hf/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
