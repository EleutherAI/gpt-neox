...
#SBATCH --output=llama-2_7b_mix_2e-5lr_%j.out
#SBATCH --error=llama-2_7b_mix_2e-5lr_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/compute/math-lm/gpt-neox/configs/v0.7/ llama-2_7b_mix_2e-5lr.yml
