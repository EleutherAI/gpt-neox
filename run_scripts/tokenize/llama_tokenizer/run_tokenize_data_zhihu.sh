...
#SBATCH --job-name="tokenize_llama-zhihu"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/zhihu/zhihu-train.jsonl\
            --output-prefix /fs/fast/u2020000280/data/zhihu_llama_tokenized/train \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/zhihu/zhihu-val.jsonl\
            --output-prefix /fs/fast/u2020000280/data/zhihu_llama_tokenized/val \
            --vocab ../tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
