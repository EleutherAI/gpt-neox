...
#SBATCH --job-name="tokenize_llama_europarl"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /home/share/jarvis/pile_split_new/EuroParl.jsonl \
            --output-prefix /fs/fast/u2020000280/data/europarl_llama_tokenized/train \
