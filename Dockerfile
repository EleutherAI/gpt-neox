...
RUN pip install -r requirements.txt && pip install -r requirements-onebitadam.txt && pip install -r requirements/requirements-sparseattention.txt && pip cache purge
