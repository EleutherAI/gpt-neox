...
#SBATCH --job-name="tokenize_llama_uspto"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /home/share/jarvis/pile_split_new/USPTO_Backgrounds.jsonl \
            --output-prefix /fs/fast/u2020000280/data/uspto_llama_tokenized/train \
