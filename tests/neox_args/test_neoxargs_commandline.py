...
def test_neoxargs_consume_neox_args():
    """
    verify neox args are correctly consumed after sending via deepspeed
    """
    from neox.neox_arguments import NeoXArgs
    ...
    # patch sys.argv so that args can be access by set_global_variables within initialize_neox
    ...
    assert args_baseline.neox_config == args_loaded.neox_config
