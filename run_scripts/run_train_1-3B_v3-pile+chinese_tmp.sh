...
#SBATCH --job-name=train_1-3B_v3-pile+chinese_tmp
...
python ./deepy.py train.py -d jarvis_configs/1-3B/v3-pile+chinese_tmp params.yml setup.yml -H jarvis_configs/1-3B/v3-pile+chinese_tmp/1-3B_v3_hostfile
