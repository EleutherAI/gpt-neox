...
def main():
    ...
    try:
        ...
        model_hf_codenames = {
            "annealing_baseline": "EleutherAI/camus",
            "annealing_filtered_v2:": "EleutherAI/stranger",
            "annealing_filtered_v5_replace_with_escelations": "EleutherAI/sisyphus",
            "annealing_filtered_v6": "EleutherAI/plague",
            "annealing_filtered_v6_pt_blocklist_mt": "EleutherAI/absurd",
        }
        if args.experiment_name in model_hf_codenames:
            args.hf_repo_name = model_hf_codenames[args.experiment_name]
            print(f"Using HF Repo Codename: {args.hf_repo_name}")
