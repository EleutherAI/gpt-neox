...
#SBATCH --output=tokenize_open-web-math-hq_train_%j.out
#SBATCH --error=tokenize_open-web-math-hq_train_%j.out
#SBATCH --time=1-00:00:00

# BYU cluster
SUBSET=open-web-math-hq
SPLIT="train"

DATA_DIR="/home/za2514/compute/open-web-math-hq_llama/${SPLIT}"
