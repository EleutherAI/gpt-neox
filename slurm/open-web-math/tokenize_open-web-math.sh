...
#SBATCH --output=tokenize_open-web-math_train_%j.out
#SBATCH --error=tokenize_open-web-math_train_%j.out
...
DATA_DIR="/home/za2514/compute/open-web-math_llama/${SPLIT}"
