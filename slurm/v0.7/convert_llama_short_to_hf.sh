...
INPUT_DIR=/home/za2514/compute/saved-weights/proofgpt_v0.7/${MODEL}/global_step${STEP}
OUT_DIR=/home/za2514/compute/saved-weights/proofgpt_v0.7/${OUT_NAME}
CONFIG_FILE=/home/za2514/compute/math-lm/gpt-neox/configs/v0.7/${MODEL}.yml
