...
#SBATCH --job-name="tokenize_llama_comments2019"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/comments2019_llama_tokenized/train \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/comments2019_llama_tokenized/val \
            --vocab ../../../../../jarvis/llama-7b-hf/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
