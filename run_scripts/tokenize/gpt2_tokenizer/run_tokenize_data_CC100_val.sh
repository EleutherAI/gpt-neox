...
#SBATCH --job-name="tokenize_CC100_zhs_data-val"
...
python tools/preprocess_data.py \
            --input /fs/fast/u2021000178/data/CC100_zhs/zh-Hans-val.jsonl \
            --output-prefix /fs/fast/u2021000178/data/CC100_zhs_tokenized/val \
