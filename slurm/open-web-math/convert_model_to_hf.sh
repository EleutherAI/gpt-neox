...
#SBATCH --output=convert_open-web-math-hq_1b_%j.out
#SBATCH --error=convert_open-web-math-hq_1b_%j.out
...
OUT_NAME=mix_step${STEP}
INPUT_DIR=/home/za2514/compute/saved-weights/open-web-math/mix_1b/global_step${STEP}
OUT_DIR=/home/za2514/compute/saved-weights/open-web-math/${OUT_NAME}
CONFIG_FILE=/home/za2514/compute/math-lm/gpt-neox/configs/open-web-math/mix_1b.yml
