...
#SBATCH --output=llama_7b_scratch_%j.out
#SBATCH --error=llama_7b_scratch_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/math-lm/gpt-neox/configs/v0.5/ llama_7B_scratch.yml
