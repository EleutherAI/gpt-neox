...
#SBATCH --job-name=train_7B_v3_llama-cn_tokenizer
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/7B/v3-llama-cn_tokenizer params.yml setup.yml -H 7B_v3_hostfile
