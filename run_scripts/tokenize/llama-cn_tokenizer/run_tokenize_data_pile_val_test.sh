...
#SBATCH --job-name="tokenize_llama-cn_pile_val_test"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /home/share/jarvis/pile/val.jsonl.zst \
            --output-prefix /fs/fast/u2021000178/data/llama-cn_tokenized/pile-val-test/val \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /home/share/jarvis/pile/test.jsonl.zst \
            --output-prefix /fs/fast/u2021000178/data/llama-cn_tokenized/pile-val-test/test \
            --vocab ../../../../../jarvis/tokenizer/llama_chinese_tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
