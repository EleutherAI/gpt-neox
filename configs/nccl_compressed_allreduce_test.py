...
# For compressed allreduce test copy this file with:
# sudo cp /home/gpt-neox/configs/nccl_compressed_allreduce_test.py /src/deepspeed/deepspeed/runtime/comm/nccl.py
...
def counted(f):
    def wrapped(*args, **kwargs):
        wrapped.calls += 1
        print("\ncompressed_allreduce counted: ",wrapped.calls,"\n")
