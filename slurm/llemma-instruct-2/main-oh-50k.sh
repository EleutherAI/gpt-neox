...
#SBATCH --array=0
#SBATCH --output=oh-50k_%a_%A.out
#SBATCH --error=oh-50k_%a_%A.out
#SBATCH --time=3-00:00:00
#SBATCH --exclude dw-1-4,dw-2-4

# BYU cluster

declare -a args=("1e-5,500")
...
run_name="llemma_7b_muinstruct-openhermes-50k_${steps}step_${lr}lr_v0.3"
...
CONF_FILE=muinstruct-oh-50k.yml
