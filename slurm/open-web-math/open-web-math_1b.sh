...
#SBATCH --output=open-web-math_1b_%j.out
#SBATCH --error=open-web-math_1b_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/compute/math-lm/gpt-neox/configs/open-web-math/ open-web-math_1b.yml
