...
#SBATCH --job-name="tokenize_llama-cn_comments2019-val"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/comments2019_tokenized/train \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/comments2019_tokenized/val \
            --vocab ../../../../../jarvis/tokenizer/llama_chinese_tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
