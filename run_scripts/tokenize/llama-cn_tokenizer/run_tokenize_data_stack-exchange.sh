...
#SBATCH --job-name="tokenize_llama-cn_stack-exchange"
...
python tools/preprocess_data.py \
            --input /home/u2021000178/share/jarvis/pile_original/data_v1/StackExchange.jsonl \
            --output-prefix /fs/fast/u2021000178/data/stack-exchange_tokenized/train \
