...
from neox.utils import report_memory
...
def training_log(
    ...
    def add_to_logging(name):
        if name in neox_args.timers.timers:
    ...
    if iteration % neox_args.log_interval == 0:
        ...
        elapsed_time = neox_args.timers("interval time").elapsed()
        ...
        neox_args.timers.log(timers_to_log, normalizer=neox_args.log_interval)
