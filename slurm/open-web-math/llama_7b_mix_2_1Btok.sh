...
#SBATCH --output=llama_7b_mix_2_1Btok_%j.out
#SBATCH --error=llama_7b_mix_2_1Btok_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/compute/math-lm/gpt-neox/configs/open-web-math/ llama_7b_mix_2_1Btok.yml
