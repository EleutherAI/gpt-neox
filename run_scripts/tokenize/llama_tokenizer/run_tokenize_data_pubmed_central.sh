...
#SBATCH --job-name="tokenize_llama_pubmed_central"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /home/share/jarvis/pile_split_new/PubMed_Central.jsonl \
            --output-prefix /fs/fast/u2020000280/data/pubmed_central_llama_tokenized/train \
