...
#SBATCH --output=llama_7b_code-v1_%j.out
#SBATCH --error=llama_7b_code-v1_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/compute/math-lm/gpt-neox/configs/v0.7/ llama_7b_code-v1.yml
