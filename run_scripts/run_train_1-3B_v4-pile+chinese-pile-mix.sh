...
#SBATCH --job-name=train_1-3B_v4-pile+chinese-pile-mix
...
source activate llm
python ./deepy.py train.py -d jarvis_configs/1-3B/v4-pile+chinese-pile-mix params.yml setup.yml -H 1-3B_v4_hostfile
