...
#SBATCH --output=mix_2_1b_%j.out
#SBATCH --error=mix_2_1b_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/compute/math-lm/gpt-neox/configs/open-web-math/ mix_2_1b.yml
