...
#SBATCH --array=1-3
#SBATCH --output=oh_%a_%A.out
#SBATCH --error=oh_%a_%A.out
#SBATCH --time=3-00:00:00
#SBATCH --exclude dw-1-4,dw-2-4

# BYU cluster

declare -a args=("1e-6,1500" "5e-6,1500" "1e-5,1500" "2e-5,1500")
...
run_name="llemma_7b_muinstruct-openhermes_${steps}step_${lr}lr_v0.3"
