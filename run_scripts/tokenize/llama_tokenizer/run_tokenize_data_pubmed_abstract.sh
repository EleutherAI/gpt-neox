...
#SBATCH --job-name="tokenize_llama_pubmed_abstract"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /home/share/jarvis/pile_split_new/PubMed_Abstracts.jsonl \
            --output-prefix /fs/fast/u2020000280/data/pubmed_abstract_llama_tokenized/train \
