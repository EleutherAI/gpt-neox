...
#SBATCH --output=llama_7b_tune-lr_3e-4_%j.out
#SBATCH --error=llama_7b_tune-lr_3e-4_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/compute/math-lm/gpt-neox/configs/v0.6/ llama_7b_tune-lr_3e-4.yml
