...
from .ec_moe_layer import ExpertChoiceMOELayer, TopKGate


class ExpertChoiceMoE(nn.Module):
    """Initialize an expert choice MoE layer.
    ...
    Arguments:
        ...
        use_residual (bool, optional): default=False, make this ExpertChoiceMoE layer a Residual ExpertChoiceMoE (https://arxiv.org/abs/2201.05596) layer.
    ...
    def __init__(self,
        ...
        log_dist(
            f'Creating ExpertChoiceMoE layer with num_experts: {num_experts} | num_local_experts: {self.num_local_experts} | expert_parallel_size: {self.ep_size}',
            [0])
        ...
        self.deepspeed_moe = ExpertChoiceMOELayer(
            TopKGate(
                hidden_size, num_experts, k, capacity_factor, eval_capacity_factor, min_capacity, noisy_gate_policy, drop_tokens, use_rts, None, top2_2nd_expert_sampling),
                                      experts,
