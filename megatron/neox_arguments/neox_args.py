...
class NeoXArgsModel(NeoXArgsTemplate):
    ...
    init_method : Literal["normal", "scaled_normal", "orthogonal", "nestler_orthogonal", "xavier_uniform", "xavier_normal", "wang_init", "small_init"] = "normal"
    """
    Init function used on all layers except ff residual outputs - choose from 
    ["normal", "scaled_normal", "orthogonal", "nestler_orthogonal", "xavier_uniform", "xavier_normal", "wang_init", "small_init"]
    """

    output_layer_init_method : Literal["normal", "scaled_normal", "orthogonal", "nestler_orthogonal", "xavier_uniform", "xavier_normal", "wang_init", "small_init"] = "scaled_normal"
    """
