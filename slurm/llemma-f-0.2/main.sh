...
#SBATCH --array=0
#SBATCH --output=llemma-f-0.1-main_%a_%A.out
#SBATCH --error=llemma-f-0.1-main_%a_%A.out
...
python ./deepy.py train.py \
    --conf_dir /home/za2514/Llemma/gpt-neox-math-lm-2-rotary/configs/llemma-f-0.2 main.yml \
