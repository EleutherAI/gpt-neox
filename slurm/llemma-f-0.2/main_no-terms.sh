...
#SBATCH --array=0
#SBATCH --output=llemma-f-0.1-main-no-terms_%a_%A.out
#SBATCH --error=llemma-f-0.1-main-no-terms_%a_%A.out
...
python ./deepy.py train.py \
    --conf_dir /home/za2514/Llemma/gpt-neox-math-lm-2-rotary/configs/llemma-f-0.2 main_no-terms.yml \
    --save "/home/za2514/saved-weights/llemma-f-0.2/llemma_7b_f_v0.2_${run_name}" \
    --load "/home/za2514/saved-weights/llemma-f-0.2/llemma_7b_f_v0.2_${run_name}" \
