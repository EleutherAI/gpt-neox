...
#SBATCH --job-name="tokenize_llama_news2016zh"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/news2016zh_llama_tokenized/train \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/news2016zh_llama_tokenized/val \
            --vocab ../../../../../jarvis/llama-7b-hf/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
