...
#SBATCH --job-name=train_1-3B_test_resume
...
### 执行你的作业
python ./deepy.py train.py -d jarvis_configs/1-3B/test_resume params.yml setup.yml -H jarvis_configs/1-3B/test_resume/1-3B_test_resume_hostfile
