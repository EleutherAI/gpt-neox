...
#SBATCH --job-name="tokenize_gpt2_comments2019"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/comments2019/comments2019-train.jsonl\
            --output-prefix /fs/fast/u2020000280/data/comments2019_gpt2_tokenized/train \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            --input /fs/fast/u2020000280/data/comments2019/comments2019-val.jsonl\
            --output-prefix /fs/fast/u2020000280/data/comments2019_gpt2_tokenized/val \
            --vocab ../../../../../jarvis/tokenizer/gpt2-vocab.json \
            --merge-file ../../../../../jarvis/tokenizer/gpt2-merges.txt \
            --dataset-impl mmap \
            --tokenizer-type GPT2BPETokenizer \
