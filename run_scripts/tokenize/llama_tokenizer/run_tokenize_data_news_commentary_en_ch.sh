...
#SBATCH --job-name="tokenize_llama_news_commentary_en_ch"
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/news_commentary_en_ch_llama_tokenized/train \
            --vocab ../../../../../jarvis/llama-7b-hf/tokenizer.model \
            --dataset-impl mmap \
...
python /home/share/gsai_joint_project/gpt-neox-2.0/tools/preprocess_data.py \
            ...
            --output-prefix /fs/fast/u2020000280/data/news_commentary_en_ch_llama_tokenized/val \
            --vocab ../../../../../jarvis/llama-7b-hf/tokenizer.model \
            --dataset-impl mmap \
            --tokenizer-type LlamaTokenizer \
            --append-eod \
