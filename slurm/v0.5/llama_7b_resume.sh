...
#SBATCH --output=llama_7b_resume_%x_%j.out
#SBATCH --error=llama_7b_resume_%x_%j.out
...
python ./deepy.py train.py --conf_dir /home/za2514/math-lm/gpt-neox/configs/v0.5/ llama_7B_resume.yml
