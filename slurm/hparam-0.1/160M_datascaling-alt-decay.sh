...
#SBATCH --output=160M_datascaling-alt-decay_%a_%A.out
#SBATCH --error=160M_datascaling-alt-decay_%a_%A.out
...
run_name=${parameters}_datascaling-alt-decay_${num_steps}step_${warmup_iters}warmup
...
python ./deepy.py train.py \
    --conf_dir ${TRAIN_DIR}/configs/hparam-0.1 base.yml ${parameters}_alt-decay.yml \
