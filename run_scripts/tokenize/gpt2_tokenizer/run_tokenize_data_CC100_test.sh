...
#SBATCH --job-name="tokenize_CC100_zhs_data-test"
...
python tools/preprocess_data.py \
            --input /fs/fast/u2021000178/data/CC100_zhs/zh-Hans-test.jsonl \
            --output-prefix /fs/fast/u2021000178/data/CC100_zhs_tokenized/test \
