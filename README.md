...
The following publications have come out of this project:
 ...
 - Black, Biderman, Hallahan, Anthony, Gao, Golding, He, Leahy, McDonell, Phang, Pieler, Prashanth, Purohit, Reynolds, Tow, Wang, Weinbach. [GPT-NeoX-20B: An Open-Source Autoregressive Language Model](https://arxiv.org/abs/2204.06745). In *Proceedings of the ACL Workshop on Challenges \& Perspectives in Creating Large Language Models*. 2022.

The following publications by other research groups use this project:
