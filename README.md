...
* A wide variety of systems and hardwares, including NVIDIA and AMD GPUs, launching via Slurm, MPI, and the IBM Job Step Manager, and has been run at scale on over a dozen different large scale computing clusters.
...
* Predefined configurations for popular architectures including Pythia, PaLM, Falcon, and LLaMA 1 \& 2. Beyond transformers, we also support Mamba and are working to bring support for RWKV and Mixture of Experts 
* Curriculum Learning
