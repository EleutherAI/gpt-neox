...
#SBATCH --output=1-4B_lr-tuning_1000warm_%a_%A.out
#SBATCH --error=1-4B_lr-tuning_1000warm_%a_%A.out
...
declare -a args=(
    "0.0002,0.00002,256" "0.002,0.0002,256" "0.003,0.0003,256" "0.006,0.0006,256" "0.01,0.001,256" "0.05,0.005,256"
)
...
run_name=${parameters}_lr-tuning_${warmup_iters}warm_${lr}
