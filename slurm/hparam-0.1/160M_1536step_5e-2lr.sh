...
#SBATCH --output=160M_1536step_5e-2lr_%a_%A.out
#SBATCH --error=160M_1536step_5e-2lr_%a_%A.out
...
run_name=${parameters}_${num_steps}step_5e-2lr_${warmup_iters}warmup
