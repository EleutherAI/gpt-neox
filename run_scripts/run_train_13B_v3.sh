...
#SBATCH --job-name=train_13B_v3

### 指定该作业需要多少个节点
### 注意！没有使用多机并行（MPI/NCCL等），下面参数写1！不要多写，多写了也不会加速程序！
#SBATCH --nodes=2
#SBATCH --nodelist=a800-[4,9]
...
### 执行你的作业
python ./deepy.py train.py -d jarvis_configs/13B/v3 params.yml setup.yml -H jarvis_configs/13B/v3/13B_v3_hostfile
