...
#SBATCH --output=70M_3072step_1000warm_%a_%A.out
#SBATCH --error=70M_3072step_1000warm_%a_%A.out
...
declare -a args=(
    "0.001,0.0001,128" "0.01,0.001,128" "0.02,0.002,128" "0.05,0.005,128" "0.1,0.01,128" 
)
...
run_name=${parameters}_3072step_${warmup_iters}warmup_${lr}lr
