...
class NeoXArgs(*BASE_CLASSES):
    ...
    def calculate_derived(self):
        ...
        # set finetune to true if we provide a soft prompt dict
        if self.soft_prompt_tuning is not None and self.soft_prompt_tuning.get(
            "enabled", False
        ):
            self.update_value("finetune", True)
